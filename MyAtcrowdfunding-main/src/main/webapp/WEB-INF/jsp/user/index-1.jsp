 ...
 <hr style="clear:both;">
          <div class="table-responsive">
            <table class="table  table-bordered">
              ...
              <tbody>
                <c:forEach items="#{page.datas}" var="user" varStatus="satats">
	                <tr>
	                  <td>${status.count }</td>
				     ...
				     <td colspan="6" align="center">
						<ul class="pagination">
							...
							<c:forEach begin="1" end="${page.totalno }" var="num">
								<li <c:if test="${page.pageno == num }">
									class="active"
									</c:if>>
								<a href="#" onclick="pageChange(${num})">${num} <span class="sr-only">(current)</span></a></li>
							</c:forEach>
