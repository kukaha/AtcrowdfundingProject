			  ...
			  <div class="panel-body">
				<form role="form" id="updateFrom">
				  <div class="form-group">
					...
					<p class="help-block label label-warning">请输入合法的名称, xx-xxxxx</p>
				  </div>
        ...
        <script type="text/javascript">
            ...
            $("#updateBtn").click(function(){
            	...
            	$.ajax({
            		...
            		beforeSend : function(){
            			if($.trim(fname.val())== ""){
            	    		layer.msg("名称不能为空，请重新输入",{time:2000,icon:5,shift:6},function(){
            	    			//获取该失败表单的文本框焦点
            	        		fname.val("")
            	        		fname.focus();
            	    		});
            		...
            		error : function(){
            			layer.msg("修改名称失败",{time:1000,icon:5,shift:6});
            		}
            	})
            });
